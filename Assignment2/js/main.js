 ...
 *
 *  Name: Hongback Son     Student ID: 133181164      Date: 9/28/2019
 *
 *
 ********************************************************************************/

// created new heroku : https://pure-reaches-30800.herokuapp.com/
// fking Heroku is expired
...
$(document).ready(function () {
  ...
  function getFilteredEmployeesModel(filterString) {
    let filterData = _.filter(employeesModel, function (employee) {
      ...
      if (
        employee.FirstName.toUpperCase().indexOf(filterString.toUpperCase()) !=
          -1 ||
        employee.LastName.toUpperCase().indexOf(filterString.toUpperCase()) !=
          -1 ||
  ...
  function getEmployeeModelById(id) {
    ...
    // deep copy
    if (findInd != -1) return _.cloneDeep(employeesModel[findInd]);
    else null;
  }
